...
if(!$loggedin) {
    echo '
	<div class="right-top-bar w-50 flex-w h-full ms-5">
				...
				<nav class="limiter-menu-desktop p-l-45 navbg">
					...
					<div class="menu-desktop ">
						<ul class="main-menu">
							...
							<li>
								<a href="about.php" class="zz">About</a>
							</li>
...
<button type="submit" type="button" class="bg-primary justify-content-center d-flex align-items-center" id="addon-wrapping"><i class="fa fa-search ms-2 me-3 text-white"></i></button>
						...
						<div class="flex-c-m h-full p-l-18 p-r-25 bor5 ms-3">
						...
						<div class="flex-c-m h-full p-lr-19">
							<div class="icon-header-item cl2 hov-cl1 trans-04 p-lr-11 js-show-sidebar">
								<i class="zmdi "><img src="images/icons/profile.png"></i>
							</div>
						</div>
					</div>
				</nav>
...
<div class="bg-white py-6 sm:py-8 lg:py-12">
    <div class="mx-auto max-w-screen-2xl px-0 md:px-0"> <!-- Adjusted padding -->
		...
		<h2 class="mb-4 text-xl font-bold text-gray-800 md:text-2xl lg:text-4xl ms-5 bg-light py-2 p-2 w-full">Results</h2>
        <div class="grid gap-x-4 gap-y-6 sm:grid-cols-3 md:gap-x-6 lg:grid-cols-4 xl:grid-cols-5 p-5">
            <?php
            require 'db.php';

            // Check if search query exists in GET request
            if(isset($_GET['search'])) {
                // Retrieve search query parameter
                $search_query = $_GET['search'];

                // SQL query to search for products
                $sql = "SELECT * FROM products WHERE p_name LIKE '%$search_query%'";
                ...
                if ($result->num_rows > 0) {
                        ...
                        <div style="border: 1px groove; border-radius: 4px;" class="product-card"> 
                            <a href="product_details.php?product_id=<?= $row['id'] ?>" class="group mb-2 block h-76 overflow-hidden bg-gray-100 lg:mb-3 nav-link">
                                ...
                                <div class="flex flex-col p-1">
                                    <p class="font-bold text-gray-800 transition duration-100 hover:text-gray-500 product-name ms-1"><?= $row['p_name'] ?></p>
                                    <div class="ms-1 test">$<?= $row['p_price'] ?></div>
                                    <div class="text-gray-500 ms-1"> <del>$60</del> </div>
                    ...
                    echo "Sorry, we couldn't find any match!;";
                }
            }
            ?>
        </div>             
...
if(isset($_GET['search'])) {
    ...
    if ($result->num_rows > 0) {
        ...
        while($row = $result->fetch_assoc()) {
            ...
            // You can display other product details here as well
        }
    } else {
        echo "0 results";
    }
