...
<body>
    ...
    <div class="bg-white py-6 sm:py-8 lg:py-12">
        <div class="mx-auto max-w-screen-2xl px-4 md:px-8">
            ...
            <form class="mx-auto max-w-lg rounded-lg border" action="" method="post">
                <div class="flex flex-col gap-4 p-4 md:p-8">

                    <div class="row">
                        <div class="col-6">
                            <label class="form-label">First Name</label>
                            <input placeholder="First Name" name="name" class="w-full rounded border bg-gray-50 px-3 py-2 text-gray-800 outline-none ring-indigo-300 transition duration-100 focus:ring" />
                        </div>
                        <div class="col-6">
                            <label class="form-label">Last Name</label>
                            <input placeholder="Last Name" name="lastname" class="w-full rounded border bg-gray-50 px-3 py-2 text-gray-800 outline-none ring-indigo-300 transition duration-100 focus:ring" />
                        </div>

                        <div class="col-6 flex-column d-flex mt-3">
                            <label class="form-label">Please Enter Phone Number</label>
                            <input placeholder="enter phone" id="phone" type="tel" name="phone" class="w-full border bg-gray-50  py-2 text-gray-800 outline-none ring-indigo-300 transition duration-100 focus:ring" />
                        </div>


                        <div class="col-6 mt-3">
                            <label class="form-label">Postal Code</label>
                            <input placeholder="postcode" name="postalcode" class="w-full rounded border bg-gray-50 px-3 py-2 text-gray-800 outline-none ring-indigo-300 transition duration-100 focus:ring" />
                        </div>
                    </div>
                    <div>
                        <label for="username" class="mb-2 inline-block text-sm text-gray-800 sm:text-base">Email</label>
                        <input type="email" placeholder="enter email..." name="username" id="username" class="w-full rounded border bg-gray-50 px-3 py-2 text-gray-800 outline-none ring-indigo-300 transition duration-100 focus:ring"/>
                    </div>
                    <div>
                        <label for="password" class="mb-2 inline-block text-sm text-gray-800 sm:text-base">Password</label>
                        <input placeholder="password" type="password" name="password" id="password" class="w-full rounded border bg-gray-50 px-3 py-2 text-gray-800 outline-none ring-indigo-300 transition duration-100 focus:ring" />
                    </div>
                    <div>
                        <label class="mb-2 inline-block text-sm text-gray-800 sm:text-base">Confirm-Password</label>
                        <input placeholder="confirm password" type="password" name="cpassword" id="cpassword" class="w-full rounded border bg-gray-50 px-3 py-2 text-gray-800 outline-none ring-indigo-300 transition duration-100 focus:ring" />
                    </div>
